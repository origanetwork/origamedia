                    ...
                    <div className="w-full lg:w-1/2 flex flex-col space-y-4 md:space-y-8">
                        {services.map((service, index) => (
                            ...
                            >
                                ...
                                >
                                    <div className={`flex items-center space-x-6 text-3xl md:text-5xl font-display font-medium transition-colors duration-300 ${hoveredIndex !== null ? (hoveredIndex === index ? 'text-black' : 'text-black/20') : 'text-black'}`}>
                        ...
                        <div className="relative h-[60px] md:h-[200px] flex items-center justify-end w-full">
                            <AnimatePresence mode="wait">
                                <motion.h3
                                    ...
                                    className={`text-6xl sm:text-5xl md:text-6xl lg:text-[8vw] font-display font-bold leading-none tracking-tighter absolute right-0 whitespace-nowrap transition-colors duration-500 ${hoveredIndex !== null ? 'text-black opacity-10' : 'text-black opacity-100'}`}
                                >
