                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className={`mt-8 h-1 w-12 bg-gradient-to-r ${step.color} rounded-full opacity-40 group-hover:opacity-100 group-hover:w-20 transition-all duration-500 md:hidden lg:block`} />
                        </motion.div>
                    ))}
                </div>
            </div>
